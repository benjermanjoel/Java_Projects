...
@WebServlet(name = "FirstNameSearchServlet", urlPatterns = "/searchFirstName")
public class FirstNameSearchServlet extends HttpServlet {
...
//            final List<Person> people = WorkbookUtility.retrievePeopleFromWorkbook(inputFile);
            ...
            String searchString = request.getParameter("firstName");

            // Create our filtered list using lambda object
            final List<Person> filtered = people.stream().filter((Person p) -> p.getFirstName()
